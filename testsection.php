<?php 
    ...
    if(isset($_POST['submittest']))
    {
        ...
        $gettestinfo = "SELECT * FROM {$_SESSION['mytesttake']}_{$classcode_id}";
        $res = mysqli_query($conn, $gettestinfo);
        ...
        if($numofresults > 0){
            while($questionsrow=mysqli_fetch_array($res)){
                ...
                array_push($questionarray, $questionsrow['test_question_id']);
                ...
                array_push($answerarray, $questionsrow['test_answer']);
        ...
        $date = date("F jS");
        $insertscore_query = 
        "INSERT INTO {$_SESSION['mytesttake']}_{$classcode_id}_takers (student_id, fullname, score, date)
    ...
    if(isset($_POST['canceltest_admin']))
    {
        $edit_state = false;
    }
...
<head>
    ...
    <title><?php echo $_SESSION['mytesttake'] ?></title>
...
<style>
    ...
    .questionnaire_wrapper .test_options{
    ...
    .questionnaire_wrapper .test_options:hover{
    ...
    .questionnaire_wrapper .test_options .test_options_wrapper{
    ...
    .questionnaire_wrapper .test_options .test_options_wrapper p{
...
<body>
    ...
    <div class="title"><?php echo $_SESSION['mytesttake']?></div>

    <div class="main_content">
        <form action="" method="post">
        <?php 
        
            $gettesttable_query = "SELECT * FROM {$_SESSION['mytesttake']}_{$classcode_id}";
            $results = mysqli_query($conn, $gettesttable_query);
        ...
        <div class="test_form">
            <div class="questionnaire_wrapper">
                <div class="questions"><?php echo $questionsrow['test_question'];?></div>
                <input type="hidden" name="answer" value="<?php echo $questionsrow['test_answer']?>">
                <div class="test_options">
                    <div class="test_options_wrapper">
                        <input type="radio" name="<?php echo $questionsrow['test_question_id']; ?>" id="1" value="<?php echo $questionsrow['test_option1'];?>" required>
                        <p><?php echo $questionsrow['test_option1'];?></p>
                    </div>
                </div>
                <div class="test_options">
                    <div class="test_options_wrapper">
                        <input type="radio" name="<?php echo $questionsrow['test_question_id']; ?>" id="2" value="<?php echo $questionsrow['test_option2'];?>" required>
                        <p><?php echo $questionsrow['test_option2'];?></p>
                    </div>
                </div>
                <div class="test_options">
                    <div class="test_options_wrapper">
                        <input type="radio" name="<?php echo $questionsrow['test_question_id']; ?>" id="3" value="<?php echo $questionsrow['test_option3'];?>" required>
                        <p><?php echo $questionsrow['test_option3'];?></p>
                    </div>
                </div>
                <div class="test_options">
                    <div class="test_options_wrapper">
                        <input type="radio" name="<?php echo $questionsrow['test_question_id']; ?>" id="4" value="<?php echo $questionsrow['test_option4'];?>" required>
                        <p><?php echo $questionsrow['test_option4'];?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main_content_btns">
            ...
            ?>
                ...
                <input type="submit" name="savetest" class="savetest_btn" value="Save">
                <?php else: ?>
                <input type="submit" name="edittest" class="edittest_btn" value="Edit">
                <?php endif ?>
                <input type="submit" name="canceltest_admin" class="canceltest_btn" value="Cancel">
            <?php 
                        }else{
            ?>
            <input type="submit" name="submittest" class="submittest_btn" value="Submit">
            <?php
                        }
                    }
                }
