            ...
            ?>
                        <div class='folderclass'>
                            ...
                            <div class="folderclass_content">
                                <ul>
                                    <li>
                                        <button type='submit' class='btn' name='getclass'><a href='folderclass.php?classcode=<?php echo $rows['acc_class_code']; ?>'>
                                            <?php 
                                                if(strlen($rows['acc_class_classname']) > 8){

                                                    echo substr($rows['acc_class_classname'], 0, 8) . '...';
